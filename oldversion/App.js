...
/* Task List
1) Build some kind of object-saving system. Have it convert specific object types into ids upon save, and convert ids back into object
    references upon load. Maybe call it ReLoSa (for Reference Load & Save)
...
const itemStats = [
    { name: "Flint Knife", desc: "Crude knife made from smashing stones." },
    { name: "Flint Stabber", desc: "A rock smashed into a point, which can be held. Makes a crude axe" },
    { name: "Twine Strips", desc: "Strips of bark fibers from decaying trees. Can be woven into ropes" },
    { name: "Small Rope", desc: "A short piece of thin rope. Can be woven to longer and/or thicker ropes as needed" },
    { name: "Removed Stick", desc: "Not a real item. Counts as one fewer sticks when a tree is cut down" },
    { name: "Long Stick", desc: "A stick of about 2 feet in length. Good for long-handled tools" },
    { name: "Short Stick", desc: "A stick of about 1 foot in length. Good for short-handled tools" },
    {
        name: "Flint Hatchet",
        desc: "A hatchet with a flint head and rope to hold it to a stick. A crude cutting tool, but enough to cut down a tree",
    },
    { name: "Flint Shovel", desc: "A shovel made from a flint head & rope to hold it to a stick. Just useful enough to dig & move dirt" },
    { name: "Flint Spear", desc: "A spear with a flint tip, held on with rope. Good enough to " },
    { name: "Flint Scythe", desc: "A stone scythe blade fastened to sticks. Difficult to use but still workable" },
    { name: "Connected log", desc: "A section of a large log. Since it's still connected, it is too heavy to move by hand" },
    { name: "Log Chunk", desc: "A chunk of log, just small enough to move & roll by hand" },
    { name: "Wooden Bucket", desc: "A bucket, carve from a single chunk of wood. Heavy on its own, but can hold liquids" },
];
