        ...
        <div>
            ...
            {showPrivacy===0? (""):(
                <div style={{border:"1px solid", maxWidth:500, margin:5, padding:7}}>
                    Privacy Policy? Well, I am collecting email addresses... these will only be used to recover accounts. In the future I may
                    use emails to provide news of updates about this game. If this policy changes in the future, I will let you know...
                    probably by email
                </div>
            )}
            {userError === "" ? (
